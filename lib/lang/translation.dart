  ...
  static const Map<String, Map<String, dynamic>> pageTitles = {
    'en': {
      ...
      'Referpage': {
        ...
        // New translations for Referee Evaluation and Metrics
        'Referee Evaluation': 'Referee Evaluation',
        'Selected Video Preview': 'Selected Video Preview',
        ...
        'Referee Summary': 'Referee Summary',
        'Avg Distance to Ball': 'Avg Distance to Ball',
        'Min Distance to Ball': 'Min Distance to Ball',
        'Sprint Count': 'Sprint Count',
        'Possession Summary': 'Possession Summary',
        'Total Distance in Possession': 'Total Distance in Possession',
        'Avg Speed in Possession': 'Avg Speed in Possession',
        'Max Speed in Possession': 'Max Speed in Possession',
        'Sprint Count in Possession': 'Sprint Count in Possession',
        'Top Ball Carriers': 'Top Ball Carriers',
        'Player ID': 'Player ID',
        'Distance (m)': 'Distance (m)',
        'Time(s)': 'Time (s)',
        'Downloads & Output': 'Downloads & Output',
        'Processed Video': 'Processed Video',
        'Save Video to Gallery': 'Save Video to Gallery',
        'Referee Evaluation Report': 'Referee Evaluation Report',
        'Save Report PDF': 'Save Report PDF',
        'Video saved to gallery!': 'Video saved to gallery!',
        'Failed to save video': 'Failed to save video',
        'Analysis failed. Please try again.': 'Analysis failed. Please try again.',
      },
      'homePage': {
        'appName': 'VAR X PRO',
        'subtitle': 'AI-Powered Football Video Analytics',
        'tagline': 'AI Football Analysis Suite',
        ...
        // New keys for Splash Screen features
        'refereesTitle': 'Referees — World DB',
        'refereesDesc': 'Complete profiles, stats, decision histories.',
        'matchEvalTitle': 'Match Evaluation (AI / Manual)',
        'matchEvalDesc': 'AI automatic scoring or pro manual review.',
        'ballTrackingTitle': 'Ball Tracking — In/Out/Goal',
        'ballTrackingDesc': 'Real-time ball position and goal detection.',
        'foulsTitle': 'Foul Detection',
        'foulsDesc': 'Computer vision: contacts, charges, dangerous tackles.',
    
        'iptvTitle': 'IPTV — Global Channels',
        'iptvDesc': 'Live sports selection from around the world.',
        'aiPrecisionTitle': 'Precise AI',
        'lowLatency': 'Latency',
        'privacyFirst': 'Privacy',
        'privacyValue': 'On-device / Cloud',
        'subtitleSplash': 'All your match analyses in one place: Referees, AI/Manual Evaluation, Ball In/Out/Goal, Fouls, VAR Offside, IPTV.',
      },
      ...
      'offsidePage': {
        ...
        // New keys for Offside Page specific
        'videoAnalysis': 'Video Analysis',
        'frameImage': 'Frame Image',
        'tapToZoomOriginal': 'Tap to zoom • Original',
        'noImageAvailable': 'No image available from backend',
        'offsideVerdict': 'OFFSIDE 🚩',
        'onsideVerdict': 'ONSIDE ⚽',
        'attackingTeam': '🔵 Attacking: {team}',
        'offsidesCount': '🚩 Offsides: {count}',
        'playersCount': '👥 Players: {count}',
        'secondLastDefenderProj': '🛡️ 2nd Last Defender Proj: {value}',
        'reason': 'Reason: {reason}',
        'tapFullscreenControls': 'Tap for Fullscreen + Controls 🎞️',
        'noOutputVideo': 'No output video available',
      ...
      'ballGoalPage': {
        ...
        'selectImageForBallInOut': 'Select a video to analyze ball position',
        'selectImageForGoalCheck': 'Select a video to check if it\'s a goal',
        'success': 'Success',
        'result': 'Result',
        ...
        'isGoal': 'Is Goal',
        // Added missing keys for full compatibility
        'specificEventTests': 'Specific Event Tests',
        'uploadVideoTestEvents': 'Upload a video to test for specific events like corner, touchline, goal line, or 6m box.',
        ...
        'detectionForEvent': 'Detection for {eventName}: {result}',
        'eventTestLabel': 'Event Test: {label}',
        'yes': 'YES',
        'no': 'NO',
        'generationInProgress': 'Generation in progress…',
        'pleaseWaitAnalyzingMedia': 'Please wait, we are analyzing your media.',
        'analysisInProgress': 'Analysis in progress...',
        'bestBallEvent': 'Best Ball Event',
        'ballEvents': 'Ball Events',
        'noBallEvents': 'No ball events detected',
        'offsideEvents': 'Offside Events',
        'noOffsideEvents': 'No offside events detected',
        'totalOuts': 'Total Outs',
        'totalOffsides': 'Total Offsides',
        'annotatedVideo': 'Annotated Video',
        'ballState': 'Ball State',
        'analysisSuccess': 'Analysis Status',
      },
      'historyPage': {
        'title': 'History',
      ...
      'foulDetectionPage': {
        ...
        // Enhanced keys for improved UX
        'refereeDecisionOptional': 'Referee Decision (Optional)',
        'none': 'None',
        ...
        'notes': 'Notes',
        'annotatedSnapshot': 'Annotated Snapshot',
        ...
        'uploadProgress': 'Upload Progress',
        'analysisInProgress': 'Analysis In Progress',
        'estimatedTime': 'Estimated Time: 10-30 min',
        'retryAnalysis': 'Retry Analysis',
        'shareResults': 'Share Results',
        'exportData': 'Export Data',
        'singleView': 'Single View',
        'multiView': 'Multi View',
        // New keys for summary items
        'foulsDetectedSingular': 'Foul detected',
        'foulsDetectedPlural': 'Fouls detected',
    ...
    'fr': {
      ...
      'Referpage': {
        ...
        // New translations for Referee Evaluation and Metrics
        'Referee Evaluation': 'Évaluation de l\'Arbitre',
        'Selected Video Preview': 'Aperçu de la Vidéo Sélectionnée',
        'Overall Score': 'Score Global',
        'Grade': 'Note',
        'Criteria Details': 'Détails des Critères',
        'Criterion': 'Critère',
        'Raw Value': 'Valeur Brute',
        'Score (%)': 'Score (%)',
        'Weight (%)': 'Poids (%)',
        'Performance Metrics': 'Métriques de Performance',
        'Referee Summary': 'Résumé de l\'Arbitre',
        'Avg Distance to Ball': 'Distance Moyenne à la Balle',
        'Min Distance to Ball': 'Distance Minimale à la Balle',
        'Sprint Count': 'Nombre de Sprints',
        'Possession Summary': 'Résumé de la Possession',
        'Total Distance in Possession': 'Distance Totale en Possession',
        'Avg Speed in Possession': 'Vitesse Moyenne en Possession',
        'Max Speed in Possession': 'Vitesse Maximale en Possession',
        'Sprint Count in Possession': 'Nombre de Sprints en Possession',
        'Top Ball Carriers': 'Principaux Porteurs de Balle',
        'Player ID': 'ID du Joueur',
        'Distance (m)': 'Distance (m)',
        'Time(s)': 'Temps (s)',
        'Downloads & Output': 'Téléchargements & Sortie',
        'Processed Video': 'Vidéo Traitée',
        'Save Video to Gallery': 'Enregistrer la Vidéo dans la Galerie',
        'Referee Evaluation Report': 'Rapport d\'Évaluation de l\'Arbitre',
        'Save Report PDF': 'Enregistrer le Rapport PDF',
        'Video saved to gallery!': 'Vidéo enregistrée dans la galerie !',
        'Failed to save video': 'Échec de l\'enregistrement de la vidéo',
        'Analysis failed. Please try again.': 'Analyse échouée. Veuillez réessayer.',
      },
      'homePage': {
        'appName': 'VAR X PRO',
        'subtitle': 'Analyse vidéo de football propulsée par l\'IA',
        'tagline': 'Suite d\'analyse de football par IA',
        ...
        // New keys for Splash Screen features
        'refereesTitle': 'Arbitres — Base de Données Mondiale',
        'refereesDesc': 'Profils complets, stats, historiques de décisions.',
        'matchEvalTitle': 'Évaluation de Match (IA / Manuelle)',
        'matchEvalDesc': 'Notation automatique IA ou revue manuelle pro.',
        'ballTrackingTitle': 'Suivi du Ballon — In/Out/Goal',
        'ballTrackingDesc': 'Position du ballon en temps réel et détection goal.',
        'foulsTitle': 'Détection de Fautes',
        'foulsDesc': 'Vision par ordinateur : contacts, charges, tacles dangereux.',
  
        'iptvTitle': 'IPTV — Chaînes Globales',
        'iptvDesc': 'Sélection de sports live du monde entier.',
        'aiPrecisionTitle': 'IA précise',
        'lowLatency': 'Latence',
        'privacyFirst': 'Confidentialité',
        'privacyValue': 'Sur appareil / Cloud',
        'subtitleSplash': 'Toutes vos analyses de match en un seul endroit : Arbitres, Évaluation IA/Manuelle, Ball In/Out/Goal, Fautes, VAR Hors-Jeu, IPTV.',
      },
      ...
      'offsidePage': {
        ...
        'frameImage': 'Image de l\'Iuframe',
        'tapToZoomOriginal': 'Appuyez pour zoomer • Original',
        'noImageAvailable': 'Aucune image disponible du backend',
        'offsideVerdict': 'HORS-JEU 🚩',
        'onsideVerdict': 'EN JEU ⚽',
        'attackingTeam': '🔵 Attaquante: {team}',
        'offsidesCount': '🚩 Hors-jeu: {count}',
        'playersCount': '👥 Joueurs: {count}',
        'secondLastDefenderProj': '🛡️ 2e Dernier Défenseur Proj: {value}',
        'reason': 'Raison: {reason}',
        'tapFullscreenControls': 'Appuyez pour Plein Écran + Contrôles 🎞️',
        'noOutputVideo': 'Aucune vidéo de sortie disponible',
      ...
      'ballGoalPage': {
        ...
        'selectImageForBallInOut': 'Sélectionnez une vidéo pour analyser la position du ballon',
        'selectImageForGoalCheck': 'Sélectionnez une vidéo pour vérifier si c\'est un but',
        'success': 'Succès',
        'result': 'Résultat',
        ...
        'isGoal': 'Est un But',
        // Added missing keys for full compatibility
        'specificEventTests': 'Tests d\'Événements Spécifiques',
        'uploadVideoTestEvents': 'Téléchargez une vidéo pour tester des événements spécifiques comme corner, ligne de touche, ligne de but ou surface de 6m.',
        'cornerKick': 'Coup de Pied de Coin',
        'touchline': 'Ligne de Touche',
        'goalLine': 'Ligne de But',
        'sixMeterBox': 'Surface de 6m',
        'testLabel': 'Tester {label}',
        'analyzingLabel': 'Analyse de {label}...',
        'detectionForEvent': 'Détection pour {eventName}: {result}',
        'eventTestLabel': 'Test d\'Événement: {label}',
        'yes': 'OUI',
        'no': 'NON',
        'generationInProgress': 'Génération en cours…',
        'pleaseWaitAnalyzingMedia': 'Veuillez patienter, nous analysons votre média.',
        'analysisInProgress': 'Analyse en cours...',
        'bestBallEvent': 'Meilleur Événement de Ballon',
        'ballEvents': 'Événements de Ballon',
        'noBallEvents': 'Aucun événement de ballon détecté',
        'offsideEvents': 'Événements de Hors-Jeu',
        'noOffsideEvents': 'Aucun événement de hors-jeu détecté',
        'totalOuts': 'Sorties Totales',
        'totalOffsides': 'Hors-Jeu Totaux',
        'annotatedVideo': 'Vidéo Annotée',
        'ballState': 'État du Ballon',
        'analysisSuccess': 'Statut de l\'Analyse',
      },
      'historyPage': {
        'title': 'Historique',
      ...
      'foulDetectionPage': {
        ...
        // Enhanced keys for improved UX
        'refereeDecisionOptional': 'Décision de l\'Arbitre (Optionnel)',
        'none': 'Aucun',
        'noOffence': 'Pas de faute',
        'yellowCard': 'Carte jaune',
        'redCard': 'Carte rouge',
        'topAction': 'Action Principale',
        'secondAction': 'Deuxième Action',
        'version': 'Version',
        'refereeDecision': 'Décision de l\'Arbitre',
        'evaluation': 'Évaluation',
        'notes': 'Notes',
        'annotatedSnapshot': 'Instantané Annoté',
        'noSnapshotAvailable': 'Aucun Instantané Disponible',
        'yellow': 'Jaune',
        'red': 'Rouge',
        'finalDecision': 'Décision Finale',
        'severityProbabilities': 'Probabilités de Gravité',
        'uploadProgress': 'Progression du Téléversement',
        'analysisInProgress': 'Analyse en Cours',
        'estimatedTime': 'Temps Estimé : 10-30 min',
        ...
        // New keys for summary items
        'foulsDetectedSingular': 'Faute détectée',
        'foulsDetectedPlural': 'Fautes détectées',
    ...
    'ar': {
      ...
      'Referpage': {
        ...
        // New translations for Referee Evaluation and Metrics
        'Referee Evaluation': 'تقييم الحكم',
        'Selected Video Preview': 'معاينة الفيديو المحدد',
        'Overall Score': 'النتيجة الإجمالية',
        'Grade': 'الدرجة',
        'Criteria Details': 'تفاصيل المعايير',
        'Criterion': 'معيار',
        'Raw Value': 'القيمة الخام',
        'Score (%)': 'النتيجة (%)',
        'Weight (%)': 'الوزن (%)',
        'Performance Metrics': 'مؤشرات الأداء',
        'Referee Summary': 'ملخص الحكم',
        'Avg Distance to Ball': 'متوسط المسافة إلى الكرة',
        'Min Distance to Ball': 'أقل مسافة إلى الكرة',
        'Sprint Count': 'عدد الركض السريع',
        'Possession Summary': 'ملخص التملك',
        'Total Distance in Possession': 'المسافة الإجمالية في التملك',
        'Avg Speed in Possession': 'متوسط السرعة في التملك',
        'Max Speed in Possession': 'أقصى سرعة في التملك',
        'Sprint Count in Possession': 'عدد الركض السريع في التملك',
        'Top Ball Carriers': 'أفضل حاملي الكرة',
        'Player ID': 'معرف اللاعب',
        'Distance (m)': 'المسافة (م)',
        'Time(s)': 'الوقت (ث)',
        'Downloads & Output': 'التنزيلات والإخراج',
        'Processed Video': 'الفيديو المعالج',
        'Save Video to Gallery': 'حفظ الفيديو في المعرض',
        'Referee Evaluation Report': 'تقرير تقييم الحكم',
        'Save Report PDF': 'حفظ تقرير PDF',
        'Video saved to gallery!': 'تم حفظ الفيديو في المعرض!',
        'Failed to save video': 'فشل في حفظ الفيديو',
      ...
      'homePage': {
        ...
        'tagline': 'حزمة تحليل كرة القدم بالذكاء الاصطناعي',
        ...
        // New keys for Splash Screen features
        'refereesTitle': 'الحكام — قاعدة بيانات عالمية',
        'refereesDesc': 'ملفات شخصية كاملة، إحصائيات، تاريخ القرارات.',
        'matchEvalTitle': 'تقييم المباراة (ذكاء اصطناعي / يدوي)',
        'matchEvalDesc': 'تسجيل تلقائي بالذكاء الاصطناعي أو مراجعة يدوية محترفة.',
        'ballTrackingTitle': 'تتبع الكرة — داخل/خارج/هدف',
        'ballTrackingDesc': 'موضع الكرة في الوقت الفعلي واكتشاف الهدف.',
        'foulsTitle': 'كشف الأخطاء',
        'foulsDesc': 'رؤية الحاسوب: الاتصالات، الدفعات، التماسات خطيرة.',
        'iptvTitle': 'IPTV — قنوات عالمية',
        'iptvDesc': 'اختيار الرياضة المباشرة من جميع أنحاء العالم.',
        'aiPrecisionTitle': 'ذكاء اصطناعي دقيق',
        'lowLatency': 'التأخير',
        'privacyFirst': 'الخصوصية',
        'privacyValue': 'على الجهاز / السحابة',
        'subtitleSplash': 'جميع تحليلات مبارياتك في مكان واحد: الحكام، تقييم الذكاء الاصطناعي/اليدوي، كرة داخل/خارج/هدف، الأخطاء، VAR التسلل، IPTV.',
      },
      ...
      'offsidePage': {
        ...
        'tapToZoomOriginal': 'اضغط للتكبير • الأصلي',
        'noImageAvailable': 'لا توجد صورة متاحة من الخلفية',
        'offsideVerdict': 'تسلل 🚩',
        'onsideVerdict': 'داخل اللعب ⚽',
        'attackingTeam': '🔵 الهجوم: {team}',
        'offsidesCount': '🚩 التسلل: {count}',
        'playersCount': '👥 اللاعبون: {count}',
        'secondLastDefenderProj': '🛡️ ثاني آخر مدافع Proj: {value}',
        'reason': 'السبب: {reason}',
        'tapFullscreenControls': 'اضغط للشاشة الكاملة + التحكم 🎞️',
        'noOutputVideo': 'لا توجد فيديو إخراج متاح',
      ...
      'ballGoalPage': {
        ...
        'isGoal': 'هل هو هدف',
        // Added missing keys for full compatibility
        'specificEventTests': 'اختبارات الأحداث المحددة',
        'uploadVideoTestEvents': 'رفع فيديو لاختبار أحداث محددة مثل الركن، خط اللمس، خط المرمى، أو منطقة الـ6م.',
        'cornerKick': 'ركلة الركن',
        'touchline': 'خط اللمس',
        'goalLine': 'خط المرمى',
        'sixMeterBox': 'منطقة الـ6م',
        'testLabel': 'اختبار {label}',
        'analyzingLabel': 'تحليل {label}...',
        'detectionForEvent': 'الكشف لـ {eventName}: {result}',
        'eventTestLabel': 'اختبار الحدث: {label}',
        'yes': 'نعم',
        'no': 'لا',
        'generationInProgress': 'جاري الإنشاء…',
        'pleaseWaitAnalyzingMedia': 'يرجى الانتظار، نحن نحلل وسائطك.',
        'analysisInProgress': 'التحليل جاري...',
        'bestBallEvent': 'أفضل حدث كرة',
        'ballEvents': 'أحداث الكرة',
        'noBallEvents': 'لم يتم كشف أحداث كرة',
        'offsideEvents': 'أحداث التسلل',
        'noOffsideEvents': 'لم يتم كشف أحداث تسلل',
        'totalOuts': 'الخروج الإجمالي',
        'totalOffsides': 'التسلل الإجمالي',
        'annotatedVideo': 'الفيديو المُعلَّم',
        'ballState': 'حالة الكرة',
        'analysisSuccess': 'حالة التحليل',
      },
      'historyPage': {
        'title': 'التاريخ',
      ...
      'foulDetectionPage': {
        ...
        // Enhanced keys for improved UX
        'refereeDecisionOptional': 'قرار الحكم (اختياري)',
        'none': 'لا شيء',
        'noOffence': 'لا خطأ',
        'yellowCard': 'بطاقة صفراء',
        'redCard': 'بطاقة حمراء',
        'topAction': 'الإجراء الأول',
        'secondAction': 'الإجراء الثاني',
        'version': 'الإصدار',
        'refereeDecision': 'قرار الحكم',
        'evaluation': 'تقييم',
        'notes': 'ملاحظات',
        'annotatedSnapshot': 'لقطة مشروحة',
        'noSnapshotAvailable': 'لا توجد لقطة متاحة',
        'yellow': 'أصفر',
        'red': 'أحمر',
        'finalDecision': 'القرار النهائي',
        'severityProbabilities': 'احتماليات الشدة',
        'uploadProgress': 'تقدم الرفع',
        'analysisInProgress': 'التحليل جاري',
        'estimatedTime': 'الوقت المتوقع: 10-30 دقيقة',
        'retryAnalysis': 'إعادة المحاولة للتحليل',
        'shareResults': 'مشاركة النتائج',
        'exportData': 'تصدير البيانات',
        'singleView': 'عرض واحد',
        'multiView': 'عروض متعددة',
        // New keys for summary items
        'foulsDetectedSingular': 'خطأ مكتشف',
        'foulsDetectedPlural': 'أخطاء مكتشفة',
